...
@endif
                       ...
                       <form action="{{route('create.user')}}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="email" name="fullname" class="form-control">
                        </div>
                        <div class="form-group">
                            <label class="form-control-label text-muted">Số điện thoại</label>
                            <input type="text" id="email" name="number_phone" class="form-control">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="form-control-label text-muted">Password Confirn</label>
                            <input type="password" id="psw" name="repassword"  class="form-control">
                        </div>
